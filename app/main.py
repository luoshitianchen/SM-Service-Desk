...
DESCRIPTION = "IT 服务台与工单系统：工单、SLA、知识库与满意度"
...
class Item(BaseModel):
    ...
    owner: str = Field(default="IT服务部", min_length=1, max_length=80)
    priority: Literal["P0", "P1", "P2", "P3"] = "P1"
    status: Literal["planned", "active", "review", "closed"] = "active"

ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "IT服务部", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
